...
public class DictPhrase {
	...
	public DictPhrase(String txt, String type, String ts, String ent, LegaLang onto) throws Exception {
		text = txt;
		synType = type;
		tense = ts;
	...
	public DictPhrase(String txt, String type, String ts, String ent, String listUnder, LegaLang onto) throws Exception {
		text = txt;
