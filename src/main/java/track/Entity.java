...
public class Entity implements Cloneable {
	...
	LegaLang onto; // the global unique ontology, saved for convenient access
	 ...
	 * @param clsName
	 */
	public Entity(String clsName, LegaLang ot) {
		name = clsName;
		id = globalIDSource.getAndIncrement();
	...
	public Entity(String name, Entity cls, int type, LegaLang ot, int pos) {
		this.name = name;
		id = globalIDSource.getAndIncrement();
		theClass = cls;
		entityType = type;
