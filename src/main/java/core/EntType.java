...
public class EntType {
	...
	public static final Pattern ptEntitySuffixEx = Pattern.compile("\\b(" + pllc + "|" + pllp + "|" + aplc + "|" + APC + "|" + apc + "|" + plc + "|" + psc + "|" + lllc + "|" + lllp + "|"
	...
	*/
	...
	public static Pattern pInc = Pattern.compile("\\b(inc|corp|co|ltd|corporation|llc|llp|associates|assoc|p\\.c)\\b", Pattern.CASE_INSENSITIVE);
	public static Pattern pJohnDoe = Pattern.compile("\\b(john\\s+doe|jane\\s+doe)s?\\b", Pattern.CASE_INSENSITIVE);
	public static Pattern pNum = Pattern.compile("\\d|\\#|\\s\\&|/", Pattern.CASE_INSENSITIVE);
	public static Pattern pOther = Pattern.compile("\\b(us|usca|mrs|ms)\\b", Pattern.CASE_INSENSITIVE);
