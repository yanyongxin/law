...
public class Analysis {
	 ...
	 * @return
	 */
	public static List<Integer> buildKeyList(Map<Integer, List<Phrase>> rpmap) {
	 ...
	 */
	public static List<List<Analysis>> findBestNew(Map<Integer, List<Phrase>> rpmap, List<Integer> keylist, int topN, List<Integer> segments) {
